...
ingestion_dag = DAG('alt_ingestion_pipeline', default_args=default_args, schedule_interval='None')
...
load_auction_items >> populate_certificates << populate_transaction_amount
