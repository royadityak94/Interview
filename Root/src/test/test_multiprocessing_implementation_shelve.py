# -*- coding: utf-8 -*-
# Unit testing of tlhe multiprocessing_implementation_shelve.py file
...
from multiprocessing_implementation_shelve import multiprocessing_implementation_shelve
from validate_results import validate_results

class Test(TestCase):
    def test_multiprocessing_implementation_shelve_file1(self):
        """
        ...
        current_output_path = multiprocessing_implementation_shelve(input_file=input_path,
            tmp_dir='tmp/', chunk_size=(1024*2))
        # Unit testing the module
        self.assertTrue(validate_results(expected_output_path, \
            current_output_path, 0)['status'][0])

    def test_multiprocessing_implementation_shelve_file2(self):
        """
    ...
    def test_multiprocessing_implementation_shelve_file3(self):
        """
