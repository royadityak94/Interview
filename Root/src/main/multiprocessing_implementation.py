# -*- coding: utf-8 -*-
# Code for implementing task using multiprocessing
...
def multiprocessing_implementation(input_file: str, output_file: str=None,
    ...
    attempt to speedup the data-wrangling tasks. For detailed analysis refer to
    the Readme.md file.
    ...
    if not output_file:
        output_file = generate_output_file_path(input_file, 'mproc_nonnaive')
    ...
    chunk_activities = Counter() # Registering the chunk counter
...
if __name__ == '__main__':
    ...
    try:
        ...
        output_file_path = multiprocessing_implementation(args.input,
            args.output, args.chunksize)
