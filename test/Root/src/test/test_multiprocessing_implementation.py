# -*- coding: utf-8 -*-
# Unit testing of tlhe multiprocessing_implementation.py file
...
from multiprocessing_implementation import multiprocessing_implementation
from validate_results import validate_results

class Test(TestCase):
    def test_multiprocessing_implementation_file1(self):
        """
        ...
        current_output_path = multiprocessing_implementation(input_file=input_path,
            chunk_size=(1024*2))
        # Unit testing the module
        self.assertTrue(validate_results(expected_output_path, \
            current_output_path, 0)['status'][0])

    def test_multiprocessing_implementation_file2(self):
        """
    ...
    def test_multiprocessing_implementation_file3(self):
        """
