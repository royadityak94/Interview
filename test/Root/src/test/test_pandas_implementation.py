# -*- coding: utf-8 -*-
# Unit testing of tlhe pandas_implementation.py file
...
from pandas_implementation import pandas_implementation
from validate_results import validate_results

class Test(TestCase):
    def test_pandas_implementation_file1(self):
        """
        ...
        current_output_path = pandas_implementation(input_file_path=input_path)
        # Unit testing the module
        self.assertTrue(validate_results(expected_output_path, \
            current_output_path, 0)['status'][0])

    def test_pandas_implementation_file2(self):
        """
    ...
    def test_pandas_implementation_file3(self):
        """
