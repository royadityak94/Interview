...
# Helper module to unit test Anagram().get_anagrams(self, input_string, maximum_size=None)
...
# Helper module to unit test Anagram().add_custom_words(self, new_words, local_only=False)
